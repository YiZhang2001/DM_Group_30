...
openxlsx::saveWorkbook(wb, paste0('Analysis_Results/analysis_results_',this_filename_date,'_',this_filename_time,'.xlsx'), overwrite = FALSE)
...
ggsave(paste0(sub_folder_name,'/age_violin_chart.png'), plot = age_violin_chart, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/product_price_distribution.png'), plot = product_price_distribution, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/top_3_category_based_on_sales.png'), plot = top_3_category_based_on_sales, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/top_10_products_based_on_sales.png'), plot = top_10_products_based_on_sales, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/total_customers_on_number_of_cards.png'), plot = total_customers_on_number_of_cards, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/top_3_suppliers.png'), plot = top_3_suppliers, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/time_series_of_order_daily.png'), plot = time_series_of_order_daily, width = 8, height = 6, units = 'in')
ggsave(paste0(sub_folder_name,'/most_used_vouchers_from_order.png'), plot = most_used_vouchers_from_order, width = 8, height = 6, units = 'in')
